      ...
      <div className="container about-grid">
        ...
        <Reveal delay={120}>
          ...
          <p className="about-summary">
            ...
            <span className="highlight">AI/ML engineer</span> who enjoys the whole journey — from
            designing a database schema to shipping a polished interface a real person will use.
            My work spans <span className="highlight">React and React Native</span> on the
            frontend, <span className="highlight">Node.js, Express and Spring Boot</span> on the
            backend, and applied machine learning with{" "}
            <span className="highlight">Python and PyTorch</span>. I'm detail-oriented, curious
            about how systems fit together, and genuinely enjoy the process of learning new tools
            well enough to build with them.
          </p>

          <div className="about-quote">
            "I don't just dream about success — I work for it, I believe in it, and I achieve it."
          </div>
